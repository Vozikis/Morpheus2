...
echo "  D_MODEL=$D_MODEL NHEAD=$NHEAD NUM_LAYERS=$NUM_LAYERS DROPOUT=$DROPOUT LOG_SIGMA_MIN=$LOG_SIGMA_MIN LOG_SIGMA_MAX=$LOG_SIGMA_MAX SURPRISE_MODE=$SURPRISE_MODE AMP=$AMP MULTI_GPU=$MULTI_GPU GPU_COUNT=$GPU_COUNT GPU_COUNT_RAW=$GPU_COUNT_RAW DDP_BACKEND=$DDP_BACKEND MASTER_PORT=$MASTER_PORT"
